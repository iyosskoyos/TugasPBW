<div style="width:18%; height: 100%;position:absolute;" class="w3-theme-l4 w3-padding-left">
    <div style="margin: 10px">
       ...
       <text  style="margin-top:10px;display:block;font-weight: bold; font-size:19px">2011730053</text>

       <text  style="margin-top:10px;display:block;font-weight: bold; font-size:19px">Maria Veronica</text>
       ...
       <div class="w3-padding-left w3-margin-top" id="leftnav">
           <a href="#" ><i  class = "fa fa-home " style="font-size:30px;margin-right:20px"></i>
